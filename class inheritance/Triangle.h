...
class Triangle : public Shape {
 private:
  float x1;  // The x1 of the triangle
  float y1;  // The y1 of the triangle
  float x2;  // The x2 of the triangle
  float y2;  // The y2 of the triangle
  float x3;  // The x3 of the triangle
  float y3;  // The y3 of the triangle

 public:
  // Constructor
  Triangle(string n, float x1, float y1, float x2, float y2, float x3,
           float y3);
